...
// Will set this as the default language_list.blade.php for datepicker.
fc.datepickerLang = function(langCode, dpLangCode, dpOptions) {

	// get the FullCalendar internal option hash for this language_list.blade.php. create if necessary
	...
	if ($.datepicker) {
		...
		// Register the language_list.blade.php data.
		// FullCalendar and MomentJS use language_list.blade.php codes like "pt-br" but Datepicker
		// does it like "pt-BR" or if it doesn't have the language_list.blade.php, maybe just "pt".
		// Make an alias so the language_list.blade.php can be referenced either way.
		$.datepicker.regional[dpLangCode] =
			$.datepicker.regional[langCode] = // alias
				dpOptions;

		// Alias 'en' to the default language_list.blade.php data. Do this every time.
...
// Sets FullCalendar-specific translations. Will set the language_list.blade.php as the global default.
fc.lang = function(langCode, newFcOptions) {
	...
	// provided new options for this language_list.blade.php? merge them in
	if (newFcOptions) {
		mergeOptions(fcOptions, newFcOptions);
	}

	// compute language_list.blade.php options that weren't defined.
	...
	// set it as the default language_list.blade.php for FullCalendar
	defaults.lang = langCode;
};


// NOTE: can't guarantee any of these computations will run because not every language_list.blade.php has datepicker
...
var View = fc.View = Class.extend({
	...
	// determine language_list.blade.php options
	...
	if (langOptions) { // if language_list.blade.php options exist, rebuild...
	...
	// -----------------------------------------------------------------------------------
	// Apply overrides to the current language_list.blade.php's data
	...
	// Builds a moment using the settings of the current calendar: timezone and language_list.blade.php.
