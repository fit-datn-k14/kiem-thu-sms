...
<head>
    ...
    <!-- plugins:css -->
    <link rel="stylesheet" href="{{ load_asset('vendors/mdi/css/materialdesignicons.min') }}">
    <link rel="stylesheet" href="{{ load_asset('vendors/css/vendor.bundle.base') }}">
    <!-- endinject -->
    <!-- Plugin css for this page -->
    <link rel="stylesheet" href="{{ load_asset('vendors/flag-icon-css/css/flag-icon.min') }}">
    <link rel="stylesheet" href="{{ load_asset('vendors/jvectormap/jquery-jvectormap') }}">
    <!-- End plugin css for this page -->
    <!-- Layout styles -->
    <link rel="stylesheet" href="{{ load_asset('css/demo/style') }}">
    <!-- End layout styles -->
        ...
        <header class="mdc-top-app-bar">
            <div class="mdc-top-app-bar__row">
                ...
                <span class="d-flex align-items-center">
                  <span class="figure">
                    <img src="{{ load_asset('images/faces/face1.jpg') }}" alt="user" class="user">
                  </span>
                            ...
                            <ul class="mdc-list" role="menu" aria-hidden="true" aria-orientation="vertical">
                                <li class="mdc-list-item" role="menuitem">
                                    <div class="item-thumbnail">
                                        <img src="{{ load_asset('images/faces/face4.jpg') }}" alt="user">
                                    </div>
                                    <div class="item-content d-flex align-items-start flex-column justify-content-center">
                                ...
                                <li class="mdc-list-item" role="menuitem">
                                    <div class="item-thumbnail">
                                        <img src="{{ load_asset('images/faces/face2.jpg') }}" alt="user">
                                    </div>
                                    <div class="item-content d-flex align-items-start flex-column justify-content-center">
                                ...
                                <li class="mdc-list-item" role="menuitem">
                                    <div class="item-thumbnail">
                                        <img src="{{ load_asset('images/faces/face3.jpg') }}" alt="user">
                                    </div>
                                    <div class="item-content d-flex align-items-start flex-column justify-content-center">
